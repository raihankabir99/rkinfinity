export const handleAiFallback = async (messages, env, language) => {
  ...
  if (!apiKey) {
    ...
    const reply = isBengali
      ? "দুঃখিত, এআই সঠিকভাবে কনফিগার করা হয়নি।"
      : "Sorry, the AI is not configured correctly.";
  ...
  try {
    ...
    if (!data.candidates || data.candidates.length === 0) {
      ...
      const reply = isBengali
        ? "দুঃখিত, আমি এআই থেকে কোনো উত্তর পাইনি। অনুগ্রহ করে আবার চেষ্টা করুন।"
        : "Sorry, I received an empty response from the AI. Please try again.";
      return { content: reply, source: "error" };
    }
    ...
    const responseText =
      ...
      (isBengali
        ? "দুঃখিত, আমি একটি উত্তর তৈরি করতে পারিনি।"
    ...
    const reply = isBengali
      ? "দুঃখিত, উত্তর তৈরি করার সময় একটি ত্রুটি হয়েছে। অনুগ্রহ করে আবার চেষ্টা করুন।"
