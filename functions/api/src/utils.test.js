...
const testCases = [
    ...
    { input: 'প্রজেক্টের কাজ কী অবস্থায় আছে?', expected: true, description: 'Bengali keyword "kaj"' },
    ...
    // English text
    { input: 'What is the status of my project?', expected: false, description: 'Standard English query' },
    { input: 'Can you track my order?', expected: false, description: 'English with keyword "track"' }, // Note: 'track' is not a Bengali keyword
    { input: 'hello world', expected: false, description: 'Simple English' },

    // Mixed language (should detect Bengali if present)
    { input: 'Hello, আমাদের কাজ কেমন চলছে?', expected: true, description: 'Mixed English and Bengali' },
