  ...
  head: () => ({
    meta: [
      { title: "rkInfinity — SEO Expert · Digital Marketer · Web Developer" },
      {
        name: "description",
        content:
          "Premium digital craftsmanship by RK. SEO, growth marketing, and engineering for ambitious brands.",
      },
      { property: "og:title", content: "rkInfinity — Digital Excellence" },
      {
        property: "og:description",
        content: "SEO Expert · Digital Marketer · Web Developer · Story Writer.",
      },
    ],
  }),
  component: Home,
    ...
    <PageShell>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 md:py-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="mt-8 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Building infinite possibilities at the intersection of search, code, and story. I help
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            },
            {
              icon: TrendingUp,
              t: "Growth Marketing",
              d: "Performance campaigns, funnels, and analytics that turn traffic into revenue.",
            },
            {
              icon: Code2,
          ...
          {[
            {
              icon: KeyRound,
              t: "Keyword Research",
              d: "Intent-mapped keyword universes that target real revenue.",
            },
            {
              icon: Wrench,
              t: "Technical SEO",
              d: "Crawl, schema, and Core Web Vitals tuned to perfection.",
            },
            {
              icon: LinkIcon,
              t: "Link Building",
              d: "Editorial links from publications your buyers already read.",
            },
            {
              icon: FileText,
              t: "Content Strategy",
              d: "Topic clusters and editorial calendars that earn authority.",
            },
            {
              icon: FileCheck2,
              t: "On-Page SEO",
              d: "Headings, internal links, and entity coverage that rank.",
            },
            {
              icon: ClipboardCheck,
              t: "SEO Audits",
      ...
      <section className="mx-auto max-w-7xl px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            {
              t: "The Compounding SEO Playbook",
              d: "How to build a content engine that earns itself a 10x return over 24 months.",
              c: "SEO",
              r: "8 min",
            },
            {
              t: "Why I Stopped Optimizing for Algorithms",
              d: "And started writing for humans. The data, the philosophy, and the unexpected results.",
              c: "Story",
              r: "6 min",
            },
            {
              t: "Edge-First Web Apps in 2026",
              d: "A field guide to building React applications that load in under 200ms — anywhere.",
              c: "Code",
              r: "12 min",
            },
          ].map((p, i) => (
          ...
          {[
            {
              ...
              t: "RK rebuilt our SEO from the ground up. Organic traffic 4x in 5 months.",
            },
            {
              n: "Daniel Park",
              r: "CMO, NorthEdge",
              img: "https://i.pravatar.cc/120?img=12",
              t: "A rare blend of strategy and execution. The AI-powered site is buttery fast.",
            },
            {
              n: "Aisha Rahman",
              r: "CEO, LumeWorks",
              img: "https://i.pravatar.cc/120?img=32",
              t: "Clear communication, premium delivery. Worth every penny.",
            },
            {
              n: "Marco Silva",
              r: "Owner, Atlas&Co",
